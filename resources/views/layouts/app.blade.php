    ...
    <div class="container mx-auto flex  justify-between items-center h-full p-2">
        ...
        <div class="hidden md:flex space-x-2 md:space-x-4">
            ...
            <a href="{{route('tasks.create')}}"
               class="font-medium text-gray-700 hover:text-blue-500 px-2 @if(request()->routeIs('tasks.create')) border-blue-600 @endif ">{{__('Add')}}</a>
            <a href="{{route('documentation')}}"
               class="font-medium text-gray-700 hover:text-blue-500 px-2 @if(request()->routeIs('documentation')) border-blue-600 @endif ">{{__('Docs')}}</a>
